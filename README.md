...
**Норма** - будем говорить, что в $R^{m}$ введена норма, если каждому вектору $x \in R^{m}$ сопоставлено вещественное число, обозначаемое $\left\|x\right\|$.

* $\left\| x \right\|_1 = \sum_{i=1}^{m} |x_i|$ — единичная норма;

* $\left\| x \right\|_e = \sqrt{\sum_{i=1}^{m} |x_i|^{2}}$ — евклидова норма;

* $\left\| x \right\|_\infty = \max_{1 \leq i \leq m} |x_i|$ — бесконечная норма.
