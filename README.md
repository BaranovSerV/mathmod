...
- **Функция:** `newton(f, df, x, eps=1e-6)`<br>
  ...
  <b>Сходимость метода:</b> <i>квадратичная</i> (при выборе начального приближения из достаточно малой окрестности)<br>
...
- **Функция:** `simplified_newton(f, df, x0, eps=1e-6)`<br>
